...
venue: "Pok institute"        # brief name of host site without address (e.g., "Euphoric State University")
address: "U susedov 14, Kocúrkovo"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "Paža"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "Volapük"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "10,30"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Feb 2021 31-30"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "18:00-04:45"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2021-02-30      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2021-03-31        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Pán Galán"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["P.V.R.Z.Efrajmová-P.D.P."]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
